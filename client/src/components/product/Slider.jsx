            ...
            <div>
              ...
              <div id="carouselExampleDark" className="carousel hero-bg carousel-dark slide">
                    ...
                    <div className="carousel-inner py-5">
                  {
                    ...
                    <button className="carousel-control-prev btn rounded-5" type="button" data-bstarget="#carouselExampleDark" data-bs-slide="prev">
                        <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span className="visually-hidden">Previous</span>
                    </button>
                    <button className="carousel-control-next btn" type="button" data-bs-target="#carouselExampleDark" databs-slide="next">
