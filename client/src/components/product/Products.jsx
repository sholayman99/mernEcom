              ...
              <div className="col-12">
                <div>
                  ...
                  <div className="tab-content" id="pills-tabContent">
                    ...
                    >
                    {
                            ListByRemark===null?(<ProductSkeleton />):(  <div className="container">
                                <div className="row">
                                    {
                                        ListByRemark.map((item,i) =>{
                                            let price =  <p className="bodyMedium text-dark my-1"> {item['price']} </p>
                                            if(item['discount']){
                                                ...
                                                <div key={i} className="col-md-3 p-2 col-lg-3 col-sm-6 col-12">
                                                    <Link to={`/details/${item['_id']}`} className="card shadow-sm h-100 rounded-3 bg-white">
                                                        ...
                                                        <div className="card-body">
                                                            ...
                                                            {price}
                                                            <StarRatings rating={4} starRatedColor="red" starDimension="15px"
                                                                         starSpacing="2px" />
                                                        </div>
                                                    </Link>
                                                </div>
