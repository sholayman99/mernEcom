...
//product list by filter service
...
const ProductListByFilterService = async(req)=>{
   ...
   try {
       ...
       let data = await ProductModel.aggregate([
           matchStage,addFieldStage,priceMatchStage,joinWithBrandStage,joinWithCategoryStage
           ,unwindBrandStage, unwindCategoryStage,projectionStage
       ]);
       return {status:"success" , data:data}
   }catch (e) {
...
module.exports = {
    ...
    ReviewListService,CreateReviewListService,ProductListByFilterService
}
